...
# Models for the request bodies of our new frameworks
...
# --- Framework 1: Document (Image) Translation Pipeline ---
...
# --- Framework 2: Speech Translation Pipeline ---
...
# --- Framework 3: Text-to-Speech Synthesis Pipeline ---
...
# The POST endpoint to start a job and the GET endpoint to check its status
